...
export const STUDIES = {
  'broadstreet-clinical': {
    ...
    tagline: "Spent four years building a product from nothing at Evernorth — learning the clinical research domain deeply, earning trust on an existing engineering team, and caring enough about the craft that it quietly raised the bar for the whole platform.",
    ...
    discoveryBody: [
      "Before I touched a single screen, I spent months embedded with clinicians, researchers, and data analysts — genuinely trying to understand how they thought, not just what they needed. I sat in on weekly syncs with the engineering team I eventually joined. The questions I was asking weren't about requirements. They were about how a clinical researcher defines a coverage gap differently than a field physician, and why that distinction matters for every interface decision that follows.",
      "The persona work wasn't a deliverable — it was how I learned. Mark, a data analyst with deep SQL fluency and no patience for guided wizards, became my internal compass for every design decision. If Mark would skip it, I cut it. If Mark would question it, I explained it. Getting that specific about who I was designing for is what kept the product from feeling generic.",
      "That time of listening also clarified the real problem: the goal wasn't to simplify the data. It was to make its complexity feel navigable. The researchers I was designing for wanted to be met at their level of expertise — not talked down to.",
    ],
    discoveryImages: [
    ...
    approach: [
      { title: 'Listening before designing', body: 'I spent a long time in discovery before I opened Figma — interviewing clinicians and analysts, joining engineering standups, learning the data model from the inside. The only way to design an interface that respects expert users is to understand the domain at the level they understand it. That patience up front saved a lot of rework later.' },
      { title: 'Geography as the heart of the experience', body: 'Clinical researchers think spatially — coverage gaps in a region, outbreak density by county. Grounding the whole product in the ArcGIS map wasn\'t a visual choice, it was an information design decision. The map is the first thing you see and the frame you never leave. Every filter and result surfaces in relation to place, because that\'s how the people I was designing for actually think about patients.' },
      { title: 'Caring about craft, even when it was easier not to', body: "Broadstreet lived inside Evernorth's Control Center design system, and I worked within it — but I also pushed thoughtfully past it in places where the product needed more. The care we put into the design of this one product created a kind of quiet pressure on the platform around it. Within a year, Control Center started a broader design upgrade. I didn't set out to change the platform — I just tried to do right by the product." },
      { title: 'Showing up as a teammate, not a consultant', body: "Joining an existing engineering and data team mid-project meant I had to earn my place before I could influence anything. I showed up to standups, learned the vocabulary, and tried to frame design decisions as shared problems rather than handoffs. I kept leadership informed at every pivot and made sure engineers understood the reasoning behind each choice — not just the spec." },
    ],
    evolution: [
  ...
  'broadstreet-ai': {
    ...
    approach: [
      { title: 'Teaching through doing, not explaining', body: "People don't read training documentation — but they will follow a good guide. The whole point of John Snow was that it could walk you through a search, explain what each filter meant in plain language, and make selections on your behalf when you were stuck. That shift from telling users what to do to doing it alongside them changed the entire value of the product." },
      { title: 'Designing where the agent stops', body: "One of the most careful design problems on this project was figuring out what John Snow shouldn't do. Users got curious — the agent is named after a famous epidemiologist, and people naturally wanted to explore that. We designed graceful redirects, a dedicated 'Learn More' surface, and scope boundaries that felt genuinely helpful rather than like a wall. Every edge case got real attention." },
      { title: 'Doing the research before committing to a layout', body: "I spent a lot of time studying how AI assistants were being integrated in enterprise tools before deciding on a direction. The trend was moving away from persistent sidepanels — which compete with the content they're supposed to support — toward focused agents that appear exactly when needed. That's what we built. The decision was grounded in real patterns, not guesswork." },
      { title: 'Working through technical constraints with the engineers', body: "Context window limits, hallucination boundaries, prompt constraints — these were real engineering realities that could have just become blockers. Instead, I worked directly with two engineers to turn each one into a considered design decision. What does the agent say when it reaches its limit? How do we hand back gracefully to the manual UI? Sitting with those constraints made the product more honest, not less capable." },
    ],
  ...
  'louisiana-housing': {
    ...
    approach: [
      { title: 'Starting with the decision, not the data', body: "Before I designed anything, I sat with program administrators and state officials and asked a simple question: what decision are you trying to make right now, and what would change it? That question shaped everything. Each of the five views per state was built around a specific thing a program director might walk in needing to know — bottlenecks, disbursement pace, parish-level gaps, demographic equity. Nothing made it in just because it was available." },
      { title: 'Staying in it all the way through — design and data', body: "This wasn't a project where I handed off specs and moved on. I wrote the SQL that connected the live application databases to Power BI, kept the data refreshing accurately across four states with different schemas and funding rules, and stayed close to the pipeline throughout. When something was off in the numbers, I found it. When a refresh was slow the night before a stakeholder review, I stayed up and fixed it. Caring about the data as much as the design kept everything honest." },
      { title: 'Accessibility as something I actually thought about', body: "The people using these dashboards were making high-stakes calls under pressure, often on equipment they didn't get to choose. WCAG compliance wasn't a box to check — it shaped every color, every label, every contrast decision. I also thought carefully about how demographic data was surfaced. The bar was: could someone who had never seen this dashboard understand it at a glance? That's harder than it sounds." },
      { title: 'Translating complexity for people who needed clarity', body: "Program directors were policy people, not data people. Every design decision had to work for someone in a leadership meeting who needed to act on what they were seeing in under thirty seconds. I presented updates directly to program leadership throughout the project, listened carefully to what confused them, and kept the information architecture anchored to the real decisions on the table." },
    ],
  ...
  'sar-consumer': {
    ...
    tagline: "Designed — and built — a two-sided product: a receipt that asks nothing of the consumer, and a setup that asks almost nothing of the merchant after day one. The hard part was making both sides actually feel that simple.",
    ...
    approach: [
      { title: 'Making zero friction the actual rule, not just the goal', body: "The most important design decision on Sar wasn't a screen or a flow — it was a commitment: the consumer should never have to do anything they wouldn't already do at checkout. That constraint ruled out email forms, app downloads, and account creation from the start. What was left was NFC tap → App Clip → Face ID → Apple Wallet. Every step in that sequence is something a person already does. Nothing asks for new behavior." },
      { title: 'Why Apple Wallet, not an app', body: "Wallet was a real choice, not a shortcut. It's already on every iPhone, already trusted for boarding passes and cards, and doesn't ask anyone to change how they think about their phone. The receipt lands somewhere familiar. The full app earns its download later — once someone has seen enough Wallet receipts to want more — through history, tax categorization, expense export. Trust first, download second." },
      { title: 'Two very different audiences, one product that doesn\'t show it', body: "Designing for consumers and merchants at the same time meant keeping two completely separate interaction models from ever colliding. The consumer never glimpses the merchant dashboard. The merchant never sees the consumer app. Each person has their own entry point and their own definition of what success feels like. The quiet challenge was making both journeys feel simple while sharing a single backend underneath." },
      { title: 'A merchant experience designed to go unnoticed', body: "The ideal merchant UX is one that merchants forget they set up. No new hardware — the NFC reader that handles tap-to-pay is already on every modern POS. No staff retraining needed. One connection, and every completed payment triggers a receipt automatically. I wanted the onboarding to feel like a single decision: connect your POS. After that, it just runs." },
      { title: 'I designed it and coded it — all of it', body: "Sar is a real product, not a concept. I built the consumer website in React and Vite, deployed it to Cloudflare Pages, designed and built the merchant signup flow, and set up the Supabase database. I integrated PassKit to generate the Apple Wallet passes that land on customers' phones. I use AI as a collaborator throughout development — it helps me move faster, but the decisions are mine. I also incorporated Sar as a C Corp (PBC) so it would be ready if it ever grew into something bigger." },
      { title: 'A physical NFC prototype to prove the interaction', body: "In spring 2026 I built a physical NFC hardware prototype to demonstrate the checkout flow from start to finish — tap at the terminal, Wallet pass appears on the customer's phone. Building it let me test the real latency of the interaction, watch whether the gesture felt natural without any explanation, and show the complete experience to pilot merchants in person, without needing a live POS integration behind it." },
    ],
    researchPlan: {
        ...
        {study.fieldPhotos && (
          <Section label="Learning & Testing">
            <p style={{ fontSize: isMobile ? 15 : 17, color: 'var(--text-2)', maxWidth: 600, lineHeight: 1.7, marginBottom: 32 }}>
              Before any screen existed, I spent time at coffee shops and restaurants just watching what happened at the moment of payment. Receipts got crumpled, left on the counter, or shoved into pockets and forgotten. The problem I was designing for was right there in front of me.
            </p>
