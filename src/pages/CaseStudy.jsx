...
export const STUDIES = {
  'broadstreet-clinical': {
    ...
    approach: [
      { title: 'Earning the right to design', body: "I spent months in discovery before opening a design tool: talking to clinicians, joining engineering standups, learning the data model. Understanding the domain at expert depth is what made everything that followed possible." },
      { title: 'Geography as the frame', body: "Clinical researchers think in geography. I built the entire product around the ArcGIS map, not as a feature but as the frame you never leave. Every filter and result surfaces in relation to place, because that's where the thinking happens." },
      { title: 'Craft as a quiet lever', body: "Broadstreet sat inside Evernorth's Control Center design system. Where the product needed more, I pushed past it, thoughtfully. Within a year, Control Center began a broader upgrade. I didn't set out to change the platform. I just tried to do right by the product." },
      { title: 'Colleague, not vendor', body: "I joined an existing team mid-project and had to earn trust I hadn't established. I went to the standups, learned the vocabulary, and made sure everyone understood not just what we were building, but why." },
    ],
    evolution: [
  ...
  'broadstreet-ai': {
    ...
    challenge: "The clinical database at Broadstreet was more powerful than most of the people using it realized. But learning to use it well took time that researchers, who already carried full workloads, simply didn't have. Training documentation existed. People weren't reading it. What was really needed wasn't more explanation. It was someone who could sit alongside a researcher, help them build a search in real time, and step back the moment they no longer needed help. That's a different kind of AI design problem. Less about capability. More about trust.",
    images: [
