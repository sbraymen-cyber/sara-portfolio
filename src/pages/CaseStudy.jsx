...
export const STUDIES = {
  'broadstreet-clinical': {
    ...
    approach: [
      ...
      { title: 'Showing up as a colleague, not a vendor', body: "I joined an existing engineering and data team mid-project, which meant earning trust I hadn't yet established. I went to the standups. I learned the vocabulary. I tried to bring design into the conversation as a shared problem rather than an outside perspective. And I made sure that everyone on the engineering and leadership sides understood not just what we were building, but why." },
    ],
    evolution: [
